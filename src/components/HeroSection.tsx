          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-card rounded-3xl p-3 border-thick shadow-playful max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button 
                  onClick={onSearch} 
                  size="lg" 
                  className="h-14 px-8 bg-secondary hover:bg-secondary/90 text-secondary-foreground rounded-2xl text-lg font-bold shadow-md transition-all hover:scale-105"
                >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-8">
              {['Google Scholar', 'SINTA', 'Garuda', 'PubMed', 'arXiv'].map(source => (
                <span 
                  key={source} 
                  className="px-4 py-2 text-sm font-semibold rounded-full bg-primary-foreground/20 text-primary-foreground border-2 border-primary-foreground/30 backdrop-blur-sm"
                >
                  {source}
                </span>
              ))}
